...
export const AboutUs = () => {
   return (
      <div className='footerComponentText'>
         ...
         <br />
         <h4>Great Cinema Impact Movies: </h4>
